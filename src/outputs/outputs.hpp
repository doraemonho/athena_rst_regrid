...
static const char *var_choice[NOUTPUT_CHOICES] = {
  ...
  // ISM Polarization Stokes parameters (152-154)
  "ISM_Pol_x1", "ISM_Pol_x2", "ISM_Pol_x3"
...
struct OutputParameters {
  ...
  // projected maps for physical variables
  bool proj1, proj2, proj3;
  // mask for density in projection
  Real d_mask_x1, d_mask_x2, d_mask_x3;
};
